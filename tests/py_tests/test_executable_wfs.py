...
def test_get_executable_wfs(mocker, tmpdir):  # type: ignore
    from sapporo.config import AppConfig
    ...
    assert data["workflows"] == ["https://raw.githubusercontent.com/sapporo-wes/sapporo-service/main/tests/resources/cwltool/trimming_and_qc.cwl"]


def test_not_remote_wfs(mocker, tmpdir):  # type: ignore
