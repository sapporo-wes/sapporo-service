...
test_cases = [
    ...
    ("i contain cool \xfcml\xe4uts.txt", Path("i_contain_cool_umlauts.txt")),  # Filename with umlauts
    ...
    (
        "test_case_with_special_chars_!@#$%^&*()",
        Path("test_case_with_special_chars_"),
    ),  # Filename with special characters
    (
        "filename_with_underscores_and-hyphens",
        Path("filename_with_underscores_and-hyphens"),
