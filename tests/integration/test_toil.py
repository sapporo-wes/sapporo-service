"""Integration tests for toil (toil-cwl-runner) workflow engine."""
...
class TestToilHelloWorkflow:
    def test_hello_completes(self, sapporo_client: httpx.Client) -> None:
        """Submit CWL hello workflow via toil -> poll -> assert COMPLETE."""
...
class TestToilTrimmingAndQcWorkflow:
