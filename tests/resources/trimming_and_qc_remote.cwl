...
steps:
  qc_1:
    run: https://raw.githubusercontent.com/ddbj/SAPPORO-service/master/tests/resources/fastqc.cwl
    in:
      nthreads: nthreads
      fastq: fastq_1
    out:
  ...
  qc_2:
    ...
    out:
      ...
      - stderr
  trimming:
    run: https://raw.githubusercontent.com/ddbj/SAPPORO-service/master/tests/resources/trimmomatic_pe.cwl
    in:
      nthreads: nthreads
      fastq_1: fastq_1
      fastq_2: fastq_2
