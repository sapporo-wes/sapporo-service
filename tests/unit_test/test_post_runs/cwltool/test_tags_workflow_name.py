...
def test_tags_workflow_name(delete_env_vars: None, test_client: FlaskClient, remote_resources: Dict[str, Path]) -> None:  # type: ignore
    ...
    assert res_data["request"]["tags"] == '{"workflow_name": "CWL_tags_workflow_name"}'
