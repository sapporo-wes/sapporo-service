...
def post_runs_registered_only_mode_remote() -> RunId:
    script_path = \
...
def test_registered_only_mode_remote(
        setup_test_server_registered_only_mode: None) -> None:
    res_data = post_runs_registered_only_mode_remote()
    ...
    assert data["run_log"]["name"] == "CWL_trimming_and_qc_remote"
